...
Przypadki śmiertelne zanotowano do tej pory w `r sum(a$liczba>0)` obwodach, najwięcej w `r if_else(b[1,1]=="Kijów", paste("w Kijowie"), paste0("w obwodzie ", b[1,1], "m"))` (`r b[1,4]`) oraz `r if_else(b[2,1]=="Kijów", paste("w Kijowie"), paste0("w obwodzie ", b[2,1], "m"))` (`r b[2,4]`). Śmiertelność zachorowań na Covid-19 wynosi `r d[1,4]`%.
