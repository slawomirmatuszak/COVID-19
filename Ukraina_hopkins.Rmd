...
a <- a %>%
  ...
  mutate(Obwód = if_else(Obwód!="Kijów", paste("obw.", Obwód), paste("Kijów")))
...
ggplot(a, aes(x=dzien, y=proc.zach, color=Obwód))+
  ...
  facet_wrap(~Obwód, ncol = 3)+
  scale_y_continuous(labels = percent_format(accuracy = 5L))+
  geom_smooth(method = "lm", se=F, size=2)+
  labs(x= "ilość dni od przekroczenia 100 zarażeń", y= "dzienny przyrost nowych przypadków",
       title = "Dynamika zarażeń w obwodach, które przekroczyły 300 przypadków",
       caption = "Źródło: Ministerstwo Zdrowia Ukrainy")+
  theme_bw()+
...
```
#### Porównanie wzrostu zarażeń po osiągnięciu poziomu 100 przypadów na Ukrainie, państwach sąsiadujących oraz wybranych państwach europejskich
